...
public class DepartmentListController implements Initializable, DataChangedListener
{
	...
	public void setDepartmentService(DepartementService service)
	{
	...
	private void initEditButtons() {
		...
		tableColumnEDIT.setCellFactory(param -> new TableCell<Department, Department>() {
			...
			protected void updateItem(Department obj, boolean empty) {
				...
				setGraphic(button);
				button.setOnAction(
						event -> createDialogForm(obj, "/gui/DepartmentForm.fxml", Utils_Java.currentStage(event)));
			}
		});
	}
	...
	{
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmation", "Are you sure to delete the department?");
